...
(custom-set-variables
 ...
 '(package-selected-packages
   '(olivetti cider denote zoom-window eww-lnum protobuf-mode eglot rspec-mode evil web-mode yaml-mode window-numbering which-key use-package undo-tree smex scala-mode sbt-mode restclient nyan-mode magit ido-vertical-mode ido-completing-read+ hl-todo goto-last-change git-gutter flx-ido expand-region exec-path-from-shell dracula-theme auto-indent-mode))
 '(undo-tree-auto-save-history nil))
(custom-set-faces
